                ...
                <?php if ($editable === true && (check_user_permission(PERMISSION_EDIT_ANY_PROFILE) || check_user_permission((PERMISSION_EDIT_OWN_PROFILE)))): ?>
                    ...
                    <dialog id="edit-profile-modal">
                        ...
                        <div class="dialog-body command-section">
                            <form id="formUpdateProfilePicture" data-fetch-uri='<?php echo WEBROOT; ?>/upload-profile-picture.php' data-idnumber-key=<?php echo $user["idnumber"]; ?>>
...
<?php if ($editable === True) : ?>
    ...
    <script src="assets/js/editProfilePicture.min.js"></script>
...
<?php if ($editable === True && (check_user_permission(PERMISSION_EDIT_OWN_PROFILE) || check_user_permission(PERMISSION_EDIT_ANY_PROFILE))) : ?>
    <script>
        updateCertificate();
